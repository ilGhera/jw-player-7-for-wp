...
if(isset($_POST['jwppp-skin-color-controlbar-text'])) {
	$jwppp_skin_color_controlbar_text = sanitize_text_field($_POST['jwppp-skin-color-controlbar-text']);
...
if(isset($_POST['jwppp-skin-color-controlbar-icons'])) {
	$jwppp_skin_color_controlbar_icons = sanitize_text_field($_POST['jwppp-skin-color-controlbar-icons']);
...
if(isset($_POST['jwppp-skin-color-controlbar-active-icons'])) {
	$jwppp_skin_color_controlbar_active_icons = sanitize_text_field($_POST['jwppp-skin-color-controlbar-active-icons']);
...
if(isset($_POST['jwppp-skin-color-controlbar-background'])) {
	$jwppp_skin_color_controlbar_background = sanitize_text_field($_POST['jwppp-skin-color-controlbar-background']);
...
if(isset($_POST['jwppp-skin-color-timeslider-progress'])) {
	$jwppp_skin_color_timeslider_progress = sanitize_text_field($_POST['jwppp-skin-color-timeslider-progress']);
...
if(isset($_POST['jwppp-skin-color-timeslider-rail'])) {
	$jwppp_skin_color_timeslider_rail = sanitize_text_field($_POST['jwppp-skin-color-timeslider-rail']);
...
if(isset($_POST['jwppp-skin-color-menus-text'])) {
	$jwppp_skin_color_menus_text = sanitize_text_field($_POST['jwppp-skin-color-menus-text']);
...
if(isset($_POST['jwppp-skin-color-menus-active-text'])) {
	$jwppp_skin_color_menus_active_text = sanitize_text_field($_POST['jwppp-skin-color-menus-active-text']);
...
if(isset($_POST['jwppp-skin-color-menus-background'])) {
	$jwppp_skin_color_menus_background = sanitize_text_field($_POST['jwppp-skin-color-menus-background']);
...
if(isset($_POST['jwppp-skin-color-tooltips-text'])) {
	$jwppp_skin_color_tooltips_text = sanitize_text_field($_POST['jwppp-skin-color-tooltips-text']);
...
if(isset($_POST['jwppp-skin-color-tooltips-background'])) {
	$jwppp_skin_color_tooltips_background = sanitize_text_field($_POST['jwppp-skin-color-tooltips-background']);
