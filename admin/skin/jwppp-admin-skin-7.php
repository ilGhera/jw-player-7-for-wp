...
echo '<td>';
echo '<input type="text" class="regular-text" name="custom-skin-url" value="' . $jwppp_custom_skin_url .'">';
echo '<p class="description">' . __('The url of the style.css file of your custom skin.', 'jwppp') . '</p>';
echo '</td>';
echo '</tr>';
...
echo '<td>';
echo '<input type="text" class="regular-text" name="custom-skin-name" value="' . $jwppp_custom_skin_name . '">';
echo '<p class="description">' . __('The name of your custom skin.', 'jwppp') . '</p>';
echo '</td>';
echo '</tr>';
...
echo '<td>';
echo '<input type="text" class="jwppp-color-field" name="jwppp-skin-color-active" value="' . $jwppp_skin_color_active . '">';
echo '<p class="description">' . __('    Active skin elements. This includes active and highlighted labels, as well scrubber time that has elapsed.', 'jwppp') . '</p>';
echo '</td>';
echo '</tr>';
...
echo '<td>';
echo '<input type="text" class="jwppp-color-field" name="jwppp-skin-color-inactive" value="' . $jwppp_skin_color_inactive . '">';
echo '<p class="description">' . __('    Skin elements that are not active. This includes scrubber time that has not yet elapsed.', 'jwppp') . '</p>';
echo '</td>';
echo '</tr>';
...
echo '<td>';
echo '<input type="text" class="jwppp-color-field" name="jwppp-skin-color-background" value="' . $jwppp_skin_color_background . '">';
