...
echo '<td class="jwppp-input-wrap" style="width: 100%;' . ($dashboard_player ? ' padding-bottom: 1rem;' : '') . '">';
...
echo '<strong>' . ($dashboard_player ? esc_html(__( 'Media URL or Media ID', 'jwppp' )) : esc_html(__( 'Media URL', 'jwppp' ))) . '</strong>';
...
echo '</label> ';
echo '<p>';
	echo '<input type="text" id="_jwppp-video-url-1" name="_jwppp-video-url-1" ';
	echo 'placeholder="' . ($dashboard_player ? esc_html(__('Add here your media url or media id', 'jwppp')) : esc_html(__('Add here your media url', 'jwppp'))) . '" ';
	echo 'value="' . esc_attr( $video_url ) . '" size="60" />';
echo '</p>';
