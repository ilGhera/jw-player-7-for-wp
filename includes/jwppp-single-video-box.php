...
echo '<strong>' . __( 'Video poster image', 'jwppp' ) . ' | </strong><a href="https://www.ilghera.com/product/jw-player-7-for-wordpress-premium/" target="_blank">Upgrade</a>';
echo '</label> ';
...
echo ' />';
echo '<strong>' . __('Autostarting on page load.', 'jwppp') . '</strong> | <a href="https://www.ilghera.com/product/jw-player-7-for-wordpress-premium/" target="_blank">Upgrade</a>';
echo '</label>';
...
echo ' />';
echo '<strong>' . __('Mute the video during playback.', 'jwppp') . '</strong> | <a href="https://www.ilghera.com/product/jw-player-7-for-wordpress-premium/" target="_blank">Upgrade</a>';
echo '</label>';
...
echo ' />';
echo '<strong>' . __('Repeat the video during playback.', 'jwppp') . '</strong> | <a href="https://www.ilghera.com/product/jw-player-7-for-wordpress-premium/" target="_blank">Upgrade</a>';
echo '</label>';
...
echo ' />';
echo '<strong>' . __('Allow to embed this video', 'jwppp') . '</strong> | <a href="https://www.ilghera.com/product/jw-player-7-for-wordpress-premium/" target="_blank">Upgrade</a>';
echo '</label>';
...
echo ' />';
echo '<strong>' . __('Allow to download this video', 'jwppp') . '</strong> | <a href="https://www.ilghera.com/product/jw-player-7-for-wordpress-premium/" target="_blank">Upgrade</a>';
echo '</label>';
...
echo ' />';
echo '<strong>' . __('Add Chapters, Subtitles or Preview Thumbnails', 'jwppp') . '</strong> | <a href="https://www.ilghera.com/product/jw-player-7-for-wordpress-premium/" target="_blank">Upgrade</a>';
echo '</label>';
